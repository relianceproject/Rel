...
const string strMessageMagic = "Rel Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int nHeight)
{
    ...
    if (pindexBest->nMoneySupply < MAX_MONEY){
       ...
       if(pindexBest->nHeight <= 10)
        {
            nSubsidy = 0 * COIN;
        }else if(pindexBest->nHeight >= 11 && nHeight <= 529201)
        {
            nSubsidy = 20 * COIN;
        }else if(pindexBest->nHeight >= 529202 && nHeight <= 1054801)
        {
            nSubsidy = 16 * COIN;
	}else if(pindexBest->nHeight >= 1054802 && nHeight <= 1580401)
        {
            nSubsidy = 14 * COIN;
	}else if(pindexBest->nHeight >= 1580402 && nHeight <= 2106001)
        {
            nSubsidy = 12 * COIN;
	}else if(pindexBest->nHeight >= 2106002 && nHeight <= 2631601)
        {
            nSubsidy = 10 * COIN;
	}else if(pindexBest->nHeight >= 2631602 && nHeight <= 3157201)
        {
            nSubsidy = 8 * COIN;
	}else if(pindexBest->nHeight >= 3157202 && nHeight <= 3682801)
        {
            nSubsidy = 6 * COIN;
	}else if(pindexBest->nHeight >= 3682802 && nHeight <= 4208401)
        {
            nSubsidy = 4 * COIN;
	}else if(pindexBest->nHeight >= 4208402 && nHeight <= 4734001)
        {
            nSubsidy = 2 * COIN;
	} else{
            nSubsidy = 1 * COIN;
...
#ifdef ENABLE_WALLET
// Rel: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (TestNet())
    {
        nStakeMinAge = 30 * 60; // test net min age is 30min
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
 int64_t ret = 0;
      ...
      if (nHeight < 10) {
        ret = 0;
    } else if (nHeight >= 11 && nHeight <= 10801) {
        ret = blockValue / 2; // MN Reward 50%
    } else if (nHeight >= 10801 && nHeight <= 140401) {
        ret = blockValue * 0.60; // MN Reward 60 %
    } else if (nHeight >= 140401 && nHeight <= 270001) {
        ret = blockValue *0.65 ; // MN Reward 65%
    } else if (nHeight >= 270001 && nHeight <= 399601) {
       ret = blockValue * 0.70; // MN Reward 70%
    } else if (nHeight >= 399601 && nHeight <= 1054801) {
        ret = blockValue * 0.75 ; // MN Reward 75%
    } else if (nHeight >= 1054801 && nHeight <=1580401) {
        ret = blockValue * 0.80 ; // MN Reward 80%
    } else if (nHeight >= 1580401 && nHeight <=4208401 ) {
        ret = blockValue * 0.85 ; // MN Reward 85%
    } else if (nHeight >= 4208401 && nHeight <=4734001 ) {
        ret = blockValue * 0.90 ; // MN Reward 90%
    } else if (nHeight > 4734001) {
                ret = blockValue * 0.90; // MN Reward 90%
       }
    return ret;
}
