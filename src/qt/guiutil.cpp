...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Rel.lnk";
}
...
{
    return GetAutostartDir() / "Rel.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Rel-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Rel-qt [" + tr("command-line options") + "]                     " + "\n";
