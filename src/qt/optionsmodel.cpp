...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeRelAmount"))
        settings.setValue("nAnonymizeRelAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeRelAmount = settings.value("nAnonymizeRelAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeRelAmount"))
        SoftSetArg("-anonymizeRelamount", settings.value("nAnonymizeRelAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeRelAmount:
            nAnonymizeRelAmount = value.toInt();
            settings.setValue("nAnonymizeRelAmount", nAnonymizeRelAmount);
            emit anonymizeRelAmountChanged(nAnonymizeRelAmount);
            break;
        default:
            break;
        }
