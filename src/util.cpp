...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Rel
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Rel
    // Mac: ~/Library/Application Support/Rel
    // Unix: ~/.Rel
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RelMN";
#else
    fs::path pathRet;
...
void createConf()       //Automatic Rel.conf generation
{
    srand(time(NULL));
    ...
    const char* nodes =  "\nport=43210"
                        ...
                        "\ndaemon=1"
                        "\nserver=1"
                        "\naddnode=23.95.214.48:22222"
                        "\naddnode=23.95.214.48:44444";
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Rel.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Reld.pid"));
